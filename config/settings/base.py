...
)  # (schoolfeed/config/settings/base.py - 3 = schoolfeed/)
APPS_DIR = ROOT_DIR.path("schoolfeed")
...
MIGRATION_MODULES = {"sites": "schoolfeed.contrib.sites.migrations"}
...
ADMINS = [("""Sanghwan Park""", "jae6120@naver.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "schoolfeed.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "schoolfeed.users.adapters.SocialAccountAdapter"
